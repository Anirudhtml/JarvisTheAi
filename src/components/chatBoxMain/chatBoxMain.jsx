...
const sampleData = [
  ...
  "Can you help me name my new cat?",
];
...
function ChatBox({ recentChats, user, setIsSidebarVisible }) {
  ...
  const handlePromptSubmission = (prompt) => {
      ...
      {chatHistory.length > 0 ? (
        <>
          ...
          <form
            onSubmit={(e) => {
              e.preventDefault();
              handlePromptSubmission(userMessage);
            }}
            className="promptSearchContainer2"
          >
        ...
        <>
          <div className="ChatBoxContainer">
            ...
            <div className="Headline">
              <span id="greeting">
                Good Morning, {user ? user.firstName : "Stranger"}.
              </span>
              <span id="subline">
                {user ? "How may I be of service today?" : ""}
              </span>
              <div className="namePrompt">
                <span>
                  {user
                    ? "Jarvis, your personal artificial intelligence assistant, designed to handle a wide range of tasks with efficiency. From managing complex systems to ensuring optimal performance of the Iron Man suits, my purpose is to assist in every possible way."
                    : "Hello, I'm J.A.R.V.I.S.—Tony Stark's AI. I handle everything from suit upgrades to witty banter. But if you want my help, you'll need to sign up first. I don't assist just anyone, you know!"}
                </span>
              </div>
            </div>
            <div className="samplePrompts">
              {sampleData.map((data) => (
                <div onClick={() => handlePromptSubmission(data)} className="prompt">
                  <p>{data}</p>
                </div>
              ))}
            </div>
            ...
            <form
              ...
              className="promptSearchContainer"
            >
              <div className="searchInputContainer">
                <svg
                  fill="#000000"
            ...
            <div className="chatHistory">
              ...
              {mutation.isLoading && (
                <div className="message loading">Jarvis is thinking...</div>
              )}
            </div>
          </div>
        </>
